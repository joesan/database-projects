...
// The dependencies we need for our script
@ import $ivy.`com.h2database:h2:1.4.186`
@ import $ivy.`com.typesafe.slick::slick:3.2.0`
@ import $ivy.`org.scala-lang.modules:scala-async_2.11:0.9.6`
@ import $ivy.`org.slf4j:slf4j-api:1.7.25`
@ import $ivy.`org.reactivestreams:reactive-streams:1.0.1`
